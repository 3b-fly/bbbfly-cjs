...
var bbbfly=bbbfly||{};bbbfly.downloader={};bbbfly.downloader._setMethod=function(a){if(!Number.isNumber(a))return!1;for(var b in bbbfly.Downloader.method)if(bbbfly.Downloader.method[b]===a)return this.Method=a,!0;return!1};bbbfly.downloader._getMethod=function(){return Number.isNumber(this.Method)?this.Method:bbbfly.Downloader.method.auto};
