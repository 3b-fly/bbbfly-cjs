...
bbbfly.dom._stopEvent=function(a){a||(a=window.event);a instanceof window.Event&&(a.stopPropagation?a.stopPropagation():a.cancelBubble=!0,a.preventDefault?a.preventDefault():a.returnValue=!1)};bbbfly.DOM={AddEvent:bbbfly.dom._addEvent,RemoveEvent:bbbfly.dom._removeEvent,StopEvent:bbbfly.dom._stopEvent};
