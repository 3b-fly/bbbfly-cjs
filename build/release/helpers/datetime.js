...
var bbbfly=bbbfly||{};bbbfly.datetime={};bbbfly.datetime._bigIntToDateTime=function(a){var b=null;if(String.isString(a)&&(a=bbbfly.DateTime.bigintPattern.exec(a)))switch(a[2]){case bbbfly.DateTime.calendar.gregorian:b=new Date,b.setUTCFullYear(parseInt(a[3])*(a[1]?-1:1)),b.setUTCMonth(parseInt(a[4])-1),b.setUTCDate(parseInt(a[5])),b.setUTCHours(parseInt(a[6])),b.setUTCMinutes(parseInt(a[7])),b.setUTCSeconds(0),b.setUTCMilliseconds(0)}return b};
