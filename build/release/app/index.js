...
bbbfly.appindex._onclick=function(a){a||(a=window.event);var b=a.target||a.srcElement;if("A"===b.tagName){a=b.getAttribute("href");var c=b.getAttribute("target");b=b.getAttribute("location");"#"===a.substring(0,1)?"_system"!==c&&(c="_self"):"_system"!==c?c="_blank":"null"===b&&(b="location=no");window.open(a,c,b);return!1}};bbbfly.AppIndex={AddURLVersion:bbbfly.appindex._addURLVersion,InitIndex:bbbfly.appindex._initIndex,RequireLeaveDialog:bbbfly.appindex._requireLeaveDialog,AllowSelfLinks:bbbfly.appindex._allowSelfLinks};
